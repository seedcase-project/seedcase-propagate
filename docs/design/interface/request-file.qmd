...
- This alternative is more closely mapped to the interface, e.g. the dropdown
  for the operator coresponds to the "operator" key here and the condition
  groups in the interface are also more simlar to how they are grouped here with
  "any".
...
subsets:
  # Showing both row syntaxes for now
