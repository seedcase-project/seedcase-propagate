...
The main purpose of this section is to keep track of the version of the data
package the request was made for. That way, the Owner can determine if a 
given request needs an update to the data depending on which version of the
data it uses.
