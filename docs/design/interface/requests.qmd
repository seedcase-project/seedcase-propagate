...
- `any`: By default, listed conditions will be combined so that a row needs to
  ...
  create a group of conditions where it is enough if one evaluates to true for a
  row to be included.
- If we wrote the expression in the example above more verbosely, it would read:
  - The value of col1 is not one of dog or cat
  - AND col2 is greater than or equal to 2012-01-01
  - AND col2 is smaller than or equal to 2012-12-31
  - AND any of the following comparisons are true:
    - col3 is greater than 404
    - col4 is smaller than 101
