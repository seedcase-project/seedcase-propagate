...
while using seedcase-propagate. You can do this by creating a new issue on our
GitHub repository.
...
To contribute to seedcase-propagate, you first need to install
...
(`seedcase-propagate/`) and running:
